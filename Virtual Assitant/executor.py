# TODO: Need to take in new query while running the find mode
...
def handleNearestObjectDirection(engine, command):
    # TODO: Update the folder directory for Mode 1
...
def handleFindObject(engine, command):
    ...
    while True:
        # TODO: How to get new speak input here?
        ...
        if isByeCommand(query):
            ...
            if objName:
                ...
                # TODO: Update the folder directory for Mode 2
...
def handleDescribeView(engine, command):
    ...
    while True:
        ...
        if isByeCommand(query):
            ...
            # TODO: Update the folder directory for Mode 3
